CREATE OR REPLACE PACKAGE CSR.compliance_register_report_pkg
IS

-- Chart aggregation types
AGG_TYPE_COUNT					CONSTANT NUMBER(10) := 1;
AGG_TYPE_COUNT_REG				CONSTANT NUMBER(10) := 2;
AGG_TYPE_COUNT_OPEN_REG			CONSTANT NUMBER(10) := 3;
AGG_TYPE_COUNT_REQ				CONSTANT NUMBER(10) := 4;
AGG_TYPE_COUNT_OPEN_REQ			CONSTANT NUMBER(10) := 5;
AGG_TYPE_COUNT_ISSUES			CONSTANT NUMBER(10) := 6;
AGG_TYPE_COUNT_OPEN_ISSUES		CONSTANT NUMBER(10) := 7;
AGG_TYPE_COUNT_OVRD_ISSUES		CONSTANT NUMBER(10) := 8;
AGG_TYPE_COUNT_CLOSED_ISSUES	CONSTANT NUMBER(10) := 9;
