CREATE OR REPLACE PACKAGE csr.quick_survey_report_pkg
IS

-- Chart aggregation types
AGG_TYPE_COUNT						CONSTANT NUMBER(10) := 1;
AGG_TYPE_SUM_SCORES					CONSTANT NUMBER(10) := 2;
AGG_TYPE_AVG_SCORE					CONSTANT NUMBER(10) := 3;
AGG_TYPE_MAX_SCORE					CONSTANT NUMBER(10) := 4;
AGG_TYPE_MIN_SCORE					CONSTANT NUMBER(10) := 5;
