...
BEGIN
	...
	SELECT 
		...
		null, null, null, 'InvitationExpired'
	  FROM event_type
	...
	SELECT
		...
		null, null, null, 'QuestionniareOverdue'
	  FROM event_type
	 WHERE class = 'QuestionnaireApproved'; -- copy the related questionnaire url
	...
	SELECT
		...
		null, null, null, 'QuestionniareOverdueSup'
	  FROM event_type
	 WHERE class = 'QuestionnaireApproved'; -- copy the related questionnaire url
END;
/
