...
-- Output from exec card_pkg.dumpcard('Chain.Cards.CreateUninvitedCompany');
DECLARE
...
BEGIN
    ...
    v_desc := 'Add company card that allows you to create a new company.';
    v_class := 'Credit360.Chain.Cards.AddCompany';
    v_js_path := '/csr/site/chain/cards/createUninvitedCompany.js';
    v_js_class := 'Chain.Cards.CreateUninvitedCompany';
    v_css_path := '';
    ...
    v_actions := T_STRING_LIST('default');
