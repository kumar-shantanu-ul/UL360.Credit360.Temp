...
ALTER TABLE csr.issue_type ADD require_due_dtm_comment NUMBER(1) DEFAULT 0 NOT NULL;

ALTER TABLE csr.issue_type ADD CONSTRAINT CHK_ISS_TYPE_REQ_DDTM_CMT CHECK (require_due_dtm_comment IN (0,1));
...
CREATE OR REPLACE VIEW csr.v$issue AS
	SELECT i.app_sid, i.issue_id, i.label, i.source_label, i.is_visible, i.source_url, i.region_sid, i.owner_role_sid, i.owner_user_sid,
		   ...
		   sysdate now_dtm, due_dtm, ist.issue_type_Id, ist.label issue_type_label, ist.require_priority, ist.require_due_dtm_comment, i.issue_priority_id, ip.due_date_offset, 
