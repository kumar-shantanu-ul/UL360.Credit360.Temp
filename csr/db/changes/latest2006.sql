...
ALTER TABLE csr.issue_type ADD ENABLE_REJECT_ACTION NUMBER(1,0) DEFAULT 1 NOT NULL;
ALTER TABLE CSRIMP.ISSUE_TYPE ADD ENABLE_REJECT_ACTION NUMBER(1,0) DEFAULT 1 NOT NULL;
