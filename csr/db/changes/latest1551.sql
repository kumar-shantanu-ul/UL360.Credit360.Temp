...
ADD ALLOW_AUTO_CLOSE NUMBER(1) DEFAULT 1 NOT NULL;

ALTER TABLE csr.issue
ADD CONSTRAINT CHK_ALLOW_AUTO_CLOSE CHECK (ALLOW_AUTO_CLOSE IN (0,1)) enable;
