...
--Adding OWNER_CAN_BE_CHANGED 	not null column in few steps
ALTER TABLE CSR.ISSUE_TYPE ADD (
	OWNER_CAN_BE_CHANGED	NUMBER(1,0),
	DELETABLE_BY_RAISER		NUMBER(1,0),
...
UPDATE CSR.ISSUE_TYPE
   SET OWNER_CAN_BE_CHANGED = 0,
	   DELETABLE_BY_RAISER = 0;

COMMIT;

ALTER TABLE CSR.ISSUE_TYPE
     MODIFY OWNER_CAN_BE_CHANGED NUMBER(1,0)  DEFAULT 0  NOT NULL;
	 
ALTER TABLE CSR.ISSUE_TYPE
     MODIFY DELETABLE_BY_RAISER NUMBER(1,0)  DEFAULT 0  NOT NULL;
...
SELECT i.app_sid, i.issue_id, i.label, i.description, i.source_label, i.is_visible, i.source_url, i.region_sid, re.description region_name, i.parent_id,
	   ...
	   ist.restrict_users_to_region, ist.deletable_by_administrator, ist.deletable_by_owner, ist.deletable_by_raiser,
