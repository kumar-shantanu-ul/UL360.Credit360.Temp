...
--ddl
ALTER TABLE csr.issue_type ADD send_alert_on_issue_raised NUMBER (1, 0);

UPDATE csr.issue_type
   SET send_alert_on_issue_raised = 0;

ALTER TABLE csr.issue_type MODIFY send_alert_on_issue_raised NUMBER (1, 0) DEFAULT 0 NOT NULL;
   
ALTER TABLE csr.issue_type ADD CONSTRAINT chk_send_alert_on_issue_raised 
	CHECK (send_alert_on_issue_raised IN (1, 0));
	
--csrimp
ALTER TABLE csrimp.issue_type ADD send_alert_on_issue_raised NUMBER (1, 0) DEFAULT 0 NOT NULL;


--add send_alert_on_issue_raised into view
