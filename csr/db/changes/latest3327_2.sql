...
-- Alter tables
ALTER TABLE CSR.INTERNAL_AUDIT ADD (EXTERNAL_PARENT_REF VARCHAR2(255));
ALTER TABLE CSRIMP.INTERNAL_AUDIT ADD (EXTERNAL_PARENT_REF VARCHAR2(255));
...
CREATE OR REPLACE VIEW csr.v$audit AS
	SELECT ia.internal_audit_sid, ia.region_sid, r.description region_description, ia.audit_dtm, ia.label,
		   ...
		   ncst.format_mask nc_score_format_mask, ia.permit_id, ia.external_audit_ref, ia.external_parent_ref,
