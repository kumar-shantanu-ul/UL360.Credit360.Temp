...
ALTER TABLE csr.issue ADD issue_escalated NUMBER (1) DEFAULT 0 NOT NULL;
ALTER TABLE csr.issue ADD CONSTRAINT chk_issue_escalated_0_or_1 CHECK (issue_escalated IN (1, 0));

ALTER TABLE csrimp.issue ADD issue_escalated NUMBER (1);
UPDATE csrimp.issue SET issue_escalated = 0;
ALTER TABLE csrimp.issue MODIFY issue_escalated NOT NULL;
ALTER TABLE csrimp.issue ADD CONSTRAINT chk_issue_escalated_0_or_1 CHECK (issue_escalated IN (1, 0));
