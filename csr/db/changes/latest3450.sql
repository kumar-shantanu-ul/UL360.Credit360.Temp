...
-- Data
-- Create api.cms/health where api.cms exists (189175 missed merge somehow)...
DECLARE
...
BEGIN
	...
	LOOP
		...
		BEGIN
			v_api_resource_sid := security.securableobject_pkg.GetSidFromPath(v_act, v_www_root, 'api.cms');
		EXCEPTION
