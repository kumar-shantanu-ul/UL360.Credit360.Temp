...
/*
DROP SEQUENCE csr.compliance_item_seq;
DROP TABLE csr.compliance_item_region;
DROP TABLE csr.compliance_req_reg;
DROP TABLE csr.compliance_regulation;
DROP TABLE csr.compliance_requirement;
DROP TABLE csr.compliance_item_tag;
DROP TABLE csr.compliance_item;
ALTER TABLE csr.tag_group DROP COLUMN applies_to_compliances;
DROP TABLE csr.country_group_country;
DROP TABLE csr.country_group;
DROP TABLE csrimp.compliance_item_region;
DROP TABLE csrimp.compliance_req_reg;
DROP TABLE csrimp.compliance_regulation;
DROP TABLE csrimp.compliance_requirement;
DROP TABLE csrimp.compliance_item_tag;
DROP TABLE csrimp.compliance_item;
DROP TABLE csrimp.map_compliance_item;
ALTER TABLE csrimp.tag_group DROP COLUMN applies_to_compliances;
DELETE FROM csr.capability where name = 'Manage compliance items';
*/
...
-- Using the ENHESA codes for these organisations to make mapping easier later on
BEGIN
