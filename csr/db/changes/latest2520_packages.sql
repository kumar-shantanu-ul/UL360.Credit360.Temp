...
ISSUE_ENHESA_TOPIC				CONSTANT NUMBER(10) := 19;
...
ALERT_UPDATED_DELEGATION		CONSTANT NUMBER(10) := 8;
...
-- 1,2,3,4 etc are defined by security_pkg LOGON_TYPE_FULL etc
LOGON_TYPE_SSO					CONSTANT NUMBER(10) := 100;
...
FLOW_CAP_SUPPLIER				CONSTANT NUMBER(10) := 1001;
...
PROCEDURE FilterSidsByLastAuditDate(
	in_act_id						IN	security_pkg.T_ACT_ID,
	in_object_sids					IN	security_pkg.T_SID_IDS,
	in_audit_date					IN	audit_log.audit_date%TYPE,
	out_cur							OUT	SYS_REFCURSOR
);
