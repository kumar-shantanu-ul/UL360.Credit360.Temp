...
BEGIN
	...
	BEGIN
		SELECT quick_survey_type_id
		 ...
		 WHERE cs_class = 'Credit360.QuickSurvey.AuditScoreSummaryType';
	EXCEPTION
		WHEN NO_DATA_FOUND THEN
			INSERT INTO csr.quick_survey_type (quick_survey_type_id, description, cs_class)
			VALUES (csr.quick_survey_type_id_seq.NEXTVAL, 'Calculation survey type', 'Credit360.QuickSurvey.AuditScoreSummaryType')
