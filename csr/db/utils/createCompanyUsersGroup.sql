...
BEGIN
	...
	-- Get the users group specific to this company
	SELECT group_sid
	  INTO v_company_users_sid
	  FROM chain.company_group
	 WHERE company_sid = &&company_sid
	   AND company_group_type_id = 2; -- Company users
	...
	-- create a new group and add the company specific group to it - all users added to that company will now have this new group
