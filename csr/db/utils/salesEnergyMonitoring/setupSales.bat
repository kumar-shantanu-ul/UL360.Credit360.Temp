...
sqlplus -L -S csr/csr@%db% @checkCRCMetering %host%
if errorlevel 255 echo exit | sqlplus -L -S csr/csr@%db% @../enableCRCMetering %host%
...
echo exit | sqlplus -L -S csr/csr@%db% @createDataSource %host%
