CREATE OR REPLACE PACKAGE CSR.compliance_library_report_pkg
IS

COMPLIANCE_POLICY_FILTER_VALUE		CONSTANT NUMBER(10) 
										:= compliance_pkg.COMPLIANCE_REGULATION + POWER(2, 16);

PARENT_LEGAL_REGISTER				CONSTANT NUMBER(10) := 1;
