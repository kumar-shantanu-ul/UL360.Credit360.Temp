CREATE OR REPLACE PACKAGE CSR.issue_report_pkg
IS

-- Chart aggregation types
AGG_TYPE_COUNT					CONSTANT NUMBER(10) := 1;
AGG_TYPE_DAYS_OPEN				CONSTANT NUMBER(10) := 2;
AGG_TYPE_DAYS_OVERDUE			CONSTANT NUMBER(10) := 3;
AGG_TYPE_AVG_DAYS_OPEN			CONSTANT NUMBER(10) := 4;
AGG_TYPE_AVG_DAYS_OVRDUE		CONSTANT NUMBER(10) := 5;

-- Not used yet but the above will probably simplify to the below
--AGG_SRC_COUNT					CONSTANT NUMBER(10) := 1;
--AGG_SRC_DAYS_OPEN				CONSTANT NUMBER(10) := 2;
--AGG_SRC_DAYS_OVERDUE			CONSTANT NUMBER(10) := 3;

-- Column types
COL_TYPE_REGION_SID				CONSTANT NUMBER(10) := 1;
COL_TYPE_RAISED_DTM				CONSTANT NUMBER(10) := 2;
COL_TYPE_RESOLVED_DTM			CONSTANT NUMBER(10) := 3;
COL_TYPE_DUE_DTM				CONSTANT NUMBER(10) := 4;
COL_TYPE_FORECAST_DTM			CONSTANT NUMBER(10) := 5;
